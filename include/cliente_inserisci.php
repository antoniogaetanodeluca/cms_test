...
<div class="pgn-admin">
	<div class="struttura_tab">
    	<div class="titolo_tab">
            ...
            <p class="nuova_news">Inserisci un nuovo <strong>cliente</strong></p>
        </div>
       
       <div class="contenuto_tab"> 
        	<form name="inserisci_news" action="include/azione.php?azione=cliente_inserisci" method="post" class="validateform" enctype="multipart/form-data">
